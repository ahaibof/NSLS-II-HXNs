...
CrXANES= {'high_e':6.03, 'low_e':5.97, 
          ...
          'energy':cr_e_list, 'mirror': 'Si', 'pitch' :0.4665,'m2p':1.3060}
          
cr_energies=[(5.97,5.98,0.005),(5.981,6.03,0.001), (6.032,6.046,0.005)]
cr_e_list = generateEPoints ( ePointsGen = cr_energies) 
e_list = generateEList(XANESParam = CrXANES)
...
Real Scan: <zp_list_xanes2d(e_list,dets1,zpssx,-4,3,70,zpssy,-7,0,70,0.15,
                    ...
                    saveLogFolder = '/data/users/2021Q2/Sprouster_2021Q2/FD')
...
def generateEPoints(ePointsGen = [(9.645,9.665,0.005),(9.666,9.7,0.0006),(9.705,9.725,0.005)]):
...
def generateEList(XANESParam = CrXANES):

    energies = XANESParam ['energy']
