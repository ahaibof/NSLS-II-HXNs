...
#
flyplot = FlyRoiPlot(['La'], channels=[1, 2, 3], use_sum=True)
fly2dplot = FlyLiveImage(['La'], channels=[1, 2, 3], use_sum=True)
fly2dplot1 = FlyLiveCrossSection(['La'], channels=[1, 2, 3], use_sum=True)
